      ...
      <AlertDialog open={resetOpen} onOpenChange={setResetOpen}>
        ...
        >
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              You just played the demo — retention offers were approved, outreach
              was drafted, the audit trail filled up. To run it again from the top,
              we need a clean slate. Lakebase branching makes that one click.
            </AlertDialogDescription>
          </AlertDialogHeader>
